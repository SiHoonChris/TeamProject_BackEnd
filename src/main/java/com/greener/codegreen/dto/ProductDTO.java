...
public class ProductDTO {
	...
	String category;           // category 대분류 추가(SiHoonChris)
	// Seller
	String product_s_id;
	// Manager
	String product_m_id;
	...
	public ProductDTO(int p_number, String p_name, int p_price, String p_content, int p_stock, int p_view,
			          String p_made, String p_usedate, String p_img, String p_thumbImg, int product_c_code,
			          String category, String product_s_id, String product_m_id) {
		...
		this.category       = category; // category 대분류 추가(SiHoonChris)
		this.product_s_id   = product_s_id;
		this.product_m_id   = product_m_id;
	}

	// category 대분류 추가(SiHoonChris)
	// ---------------------------------------------
	public String getCategory() {return category;}
	public void   setCategory(String category) {this.category = category;}
	// ----------------------------------------------
	public int    getP_number() {return p_number;}
	...
	public String getP_usedate() {return p_usedate;}
	public void   setP_usedate(String p_usedate) {this.p_usedate = p_usedate;}
	public int    getProduct_c_code() {return product_c_code;}
	public void   setProduct_c_code(int product_c_code) {this.product_c_code = product_c_code;}
	public String getProduct_s_id() {return product_s_id;}
	public void   setProduct_s_id(String product_s_id) {this.product_s_id = product_s_id;}
	public String getProduct_m_id() {return product_m_id;}
	public void   setProduct_m_id(String product_m_id) {this.product_m_id = product_m_id;}
	public String getP_img() {return p_img;}
	public void   setP_img(String p_img) {this.p_img = p_img;}
	public String getP_thumbImg() {return p_thumbImg;}
	public void   setP_thumbImg(String p_thumbImg) {this.p_thumbImg = p_thumbImg;}
